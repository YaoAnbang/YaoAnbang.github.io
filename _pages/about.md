...
**2021**
+ Sub-bit Neural Networks: Learning to Compress and Accelerate Binary Neural Networks.<br> Yikai Wang\*, Yi Yang, Fuchun Sun and Anbang Yao\#.<br> Accepted to **ICCV 2021**.<br> [Paper](https://yaoanbang.github.io/). [<font color="red">Code coming soon</font>](https://yaoanbang.github.io/).<br>
+ Learning Two-View Correspondences and Geometry Using Order-Aware Network.<br> Jiahui Zhang\*\+, Dawei Sun\*\+, Zixin Luo, Anbang Yao, Hongkai Chen, Lei Zhou, Tianwei Shen, Yurong Chen, Long Quan and Hongen Liao.<br> To appear in **IEEE Trans. on Pattern Analysis and Machine Intelligence**, 2021.<br> [Paper](https://yaoanbang.github.io/). [<font color="red">Code</font>](https://github.com/zjhthu/OANet).<br> 

**2020**

+ Explicit Residual Descent for 3D Human Pose Estimation from 2D Joint Locations.<br> Yangyuxuan Kang\*+, Anbang Yao\#+, Shandong Wang, Ming Lu, Yurong Chen and Enhua Wu.<br> **BMVC 2020**.<br> [Paper](https://www.bmvc2020-conference.com/assets/papers/0151.pdf). [<font color="red">Code</font>](https://github.com/ky66111/ERD_3DPose).<br>
+ Learning Deep Multimodal Feature Representation with Asymmetric Multi-layer Fusion.<br> Yikai Wang\*, Fuchun Sun, Ming Lu and Anbang Yao\#.<br> **ACM MM 2020**.<br> [Paper](https://dl.acm.org/doi/10.1145/3394171.3413621). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
+ PSConv: Squeezing Feature Pyramid into One Compact Poly-Scale Convolutional Layer.<br> Duo Li\*, Anbang Yao\# and Qifeng Chen.<br> **ECCV 2020**.<br> [Paper](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123660613.pdf). [<font color="red">Code</font>](https://github.com/d-li14/PSConv).<br>
+ Knowledge Transfer via Dense Cross-layer Mutual-distillation.<br> Anbang Yao\#\+ and Dawei Sun\*+.<br> **ECCV 2020**.<br> [Paper](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123600290.pdf). [<font color="red">Code</font>](https://github.com/sundw2014/DCM).<br>
+ Resolution Switchable Networks for Runtime Efficient Image Classification.<br> Yikai Wang\*, Fuchun Sun, Duo Li\* and Anbang Yao\#.<br> **ECCV 2020**.<br> [Paper](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123600528.pdf). [<font color="red">Code</font>](https://github.com/yikaiw/RS-Nets).<br>
+ Learning to Learn Parameterized Classification Networks for Scalable Input Images.<br> Duo Li\*, Anbang Yao\# and Qifeng Chen.<br> **ECCV 2020**.<br> [Paper](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123740018.pdf). [<font color="red">Code</font>](https://github.com/d-li14/SAN).<br>
+ Pointly-supervised Scene Parsing with Uncertainty Mixture.<br> Hao Zhao\*, Ming Lu\*, Anbang Yao, Yiwen Guo, Yurong Chen and Li Zhang.<br> **Computer Vision and Image Understanding**, vol 200, 103040, 2020.<br> [Paper](https://www.sciencedirect.com/science/article/pii/S1077314220300904). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
+ Learning to Draw Sight Lines.<br> Hao Zhao\*, Ming Lu\*, Anbang Yao, Yurong Chen and Li Zhang.<br> **International Journal of Computer Vision**, vol 128(5), pages 1076–1100, 2020.<br> [Paper](https://link.springer.com/article/10.1007/s11263-019-01263-4). [<font color="red">Demo</font>](https://www.youtube.com/watch?v=81RZvvBv_fw).<br>

**2019**

+ HBONet: Harmonious Bottleneck on Two Orthogonal Dimensions.<br> Duo Li\*\+, Aojun Zhou\*\+ and Anbang Yao\#.<br> **ICCV 2019**.<br> [Paper](https://openaccess.thecvf.com/content_ICCV_2019/papers/Li_HBONet_Harmonious_Bottleneck_on_Two_Orthogonal_Dimensions_ICCV_2019_paper.pdf). [<font color="red">Code</font>](https://github.com/d-li14/HBONet).<br>
+ Learning Two-View Correspondences and Geometry Using Order-Aware Network.<br> Jiahui Zhang\*\+, Dawei Sun\*\+, Zixin Luo, Anbang Yao\#, Lei Zhou, Tianwei Shen, Yurong Chen, Long Quan and Hongen Liao.<br> **ICCV 2019**.<br> [Paper](https://openaccess.thecvf.com/content_ICCV_2019/papers/Zhang_Learning_Two-View_Correspondences_and_Geometry_Using_Order-Aware_Network_ICCV_2019_paper.pdf). [<font color="red">Code</font>](https://github.com/zjhthu/OANet).<br>
+ A Closed-form Solution to Universal Style Transfer.<br> Ming Lu\*, Hao Zhao\*, Anbang Yao\#, Yurong Chen, Feng Xu and Li Zhang.<br> **ICCV 2019**.<br> [Paper](https://openaccess.thecvf.com/content_ICCV_2019/papers/Lu_A_Closed-Form_Solution_to_Universal_Style_Transfer_ICCV_2019_paper.pdf). [<font color="red">Code</font>](https://github.com/lu-m13/).<br>
+ Deeply-Supervised Knowledge Synergy.<br> Dawei Sun\*\+, Anbang Yao\#\+, Aojun Zhou\* and Hao Zhao\*.<br> **CVPR 2019**.<br> [Paper](https://openaccess.thecvf.com/content_CVPR_2019/papers/Sun_Deeply-Supervised_Knowledge_Synergy_CVPR_2019_paper.pdf). [<font color="red">Code</font>](https://github.com/sundw2014/DKS).<br>

**2018**

+ Efficient Semantic Scene Completion Network with Spatial Group Convolution.<br> Jiahui Zhang\*, Hao Zhao\*, Anbang Yao\#, Yurong Chen, Li Zhang and Hongen Liao.<br> **ECCV 2018**, (<font color="blue">*Oral*</font>).<br> [Paper](https://openaccess.thecvf.com/content_ECCV_2018/papers/Jiahui_Zhang_Efficient_Semantic_Scene_ECCV_2018_paper.pdf). [<font color="red">Code</font>](https://github.com/zjhthu/SGC-Release).<br>
+ Explicit Loss-Error-Aware Quantization for Low-Bit Deep Neural Networks.<br> Aojun Zhou\*\+, Anbang Yao\#\+, Kuan Wang\* and Yurong Chen.<br> **CVPR 2018**.<br> [Paper](https://openaccess.thecvf.com/content_cvpr_2018/papers/Zhou_Explicit_Loss-Error-Aware_Quantization_CVPR_2018_paper.pdf). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
...
+ Network Sketching: Exploiting Binary Structure in Deep CNNs.<br> Yiwen Guo, Anbang Yao, Hao Zhao\* and Yurong Chen.<br> **CVPR 2017**.<br> [Paper](https://arxiv.org/abs/1706.02021). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
+ Learning Supervised Scoring Ensemble for Emotion Recognition in the Wild.<br> Ping Hu, Dongqi Cai, Shandong Wang, Anbang Yao\# (<font color="blue">*project leader who proposed the idea*</font>) and Yurong Chen.<br> **ACM ICMI 2017**, (<font color="blue">*Oral, Winner of EmotiW-AFEW 2017 out of 100+ Teams*</font>).<br> [Paper](https://dl.acm.org/doi/10.1145/3136755.3143009). [<font color="red">Challenge Announcement</font>](https://sites.google.com/site/emotiwchallenge/).<br>

**2016**

+ Dynamic Network Surgery for Efficient DNNs.<br> Yiwen Guo\*, Anbang Yao\# and Yurong Chen.<br> **NIPS 2016**.<br> [Paper](https://papers.nips.cc/paper/2016/file/2823f4797102ce1a1aec05359cc16dd9-Paper.pdf). [<font color="red">Code</font>](https://github.com/yiwenguo/Dynamic-Network-Surgery).<br>
+ HyperNet: Towards Accurate Region Proposal Generation and Joint Object Detection.<br> Tao Kong\*, Anbang Yao\#, Yurong Chen and Fuchun Sun.<br> **CVPR 2016**, (<font color="blue">*Spotlight *</font>).<br> [Paper](https://openaccess.thecvf.com/content_cvpr_2016/papers/Kong_HyperNet_Towards_Accurate_CVPR_2016_paper.pdf). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
+ HoloNet: Towards Robust Emotion Recognition in the Wild.<br> Anbang Yao\#\+, Dongqi Cai\+, Ping Hu\+, Shandong Wang\+, Liang Sha\+ and Yurong Chen.<br> **ACM ICMI 2016**, (<font color="blue">*Oral, 1-st Runner-up of EmotiW-AFEW 2016 out of ~100 Teams*</font>).<br> [Paper](https://dl.acm.org/doi/10.1145/2993148.2997639). [<font color="red">Challenge Announcement</font>](https://sites.google.com/site/emotiw2016/).<br>

**2015 and before**

+ Capturing AU-Aware Facial Features and Their Latent Relations for Emotion Recognition in the Wild.<br> Anbang Yao\#, Junchao Shao\*\+, Ningning Ma\*\+ and Yurong Chen.<br> **ACM ICMI 2015**, (<font color="blue">**Oral, Winner of EmotiW-AFEW 2015 out of 75 Teams**</font>).<br> [Paper](https://dl.acm.org/doi/10.1145/2818346.2830585). [<font color="red">Challenge Announcement</font>](https://cs.anu.edu.au/few/emotiw2015.html).<br>
+ Robust Face Representation Using Hybrid Spatial Feature Interdependence Matrix.<br> Anbang Yao\# and Shan Yu.<br> **IEEE Trans. on Image Processing**, vol 22(8), pages 3247–3259, 2013.<br> [Paper](https://ieeexplore.ieee.org/document/6459600). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
+ A Compact Association of Particle Filtering and Kernel Based Object Tracking.<br> Anbang Yao\#, Xinggang Lin, Guijin Wang and Shan Yu.<br> **Pattern Recognition**, vol 45(7), pages 2584-2597, 2012.<br> [Paper](https://www.sciencedirect.com/science/article/pii/S0031320312000374). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
+ An Incremental Bhattacharyya Dissimilarity Measure for Particle Filtering.<br> Anbang Yao\#, Guijin Wang, Xinggang Lin and Xiujuan Chai.<br> **Pattern Recognition**, vol 43(4), pages 1244-1256, 2010.<br> [Paper](https://www.sciencedirect.com/science/article/pii/S0031320309003689). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
+ Kernel Based Articulated Object Tracking with Scale Adaptation and Model Update.<br> Anbang Yao\#, Guijin Wang, Xinggang Lin and Hao Wang.<br> **ICASSP 2008**.<br> [Paper](https://ieeexplore.ieee.org/document/4517767). [<font color="red">Code</font>](https://yaoanbang.github.io/).<br>
