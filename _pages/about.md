...
Anbang Yao is currently a <!--Senior Principal AI Scientist, also a Senior Principal Engineer (known as Senior PE, senior techncial leader recognized within Intel)--> Senior Research Director honored with the title of Senior PE at Intel and leads an interdisciplinary team <!--the research efforts on--> devoted to developing scalable high-performance <!--artificial intelligence--> AI inference systems. ***He is best known for his research in AI model compression, acceleration and architecture designs***. As the corresponding and or first author, he has published about 50 top-tier research papers in ICLR, NeurIPS, ICML, AAAI, CVPR, ICCV, ECCV, TPAMI and etc. Five of his representative research works, including INQ (Incremental Network Quantization) for low-bit neural networks, DNS (Dynamic Network Surgery) for sparse neural networks, HyperNet for efficient object detection, OANet (Order-Aware Network) for geometric correspondence learning and ODConv (Omni-dimensional Dynamic Convolution) for lightweight attentive neural networks with over 5000 citations in total, are selected into Most Influential ICLR/NeurIPS/CVPR/ICCV Papers in Google Scholar Metrics [<font color="DodgerBlue">2021</font>](https://scholar.google.com/citations?hl=en&view_op=list_hcore&venue=eqYFflc_uhEJ.2021&vq=en&cstart=60)/[<font color="DodgerBlue">2021</font>](https://scholar.google.com/citations?hl=en&view_op=list_hcore&venue=FXe-a9w0eycJ.2021&vq=en&cstart=140)/[<font color="DodgerBlue">2021</font>](https://scholar.google.com/citations?hl=en&view_op=list_hcore&venue=0032SoU2xY4J.2021&vq=en&cstart=60)/[<font color="DodgerBlue">2022</font>](https://scholar.google.com/citations?hl=en&view_op=list_hcore&venue=0032SoU2xY4J.2022&vq=en&cstart=60)/[<font color="DodgerBlue">2023</font>](https://scholar.google.com/citations?hl=en&view_op=list_hcore&venue=Umlb1kMURG4J.2023&vq=en&cstart=160)/[<font color="DodgerBlue">2024</font>](https://scholar.google.com/citations?hl=en&view_op=list_hcore&venue=Umlb1kMURG4J.2024&vq=en&cstart=200)/[<font color="DodgerBlue">2025</font>](https://scholar.google.com/citations?hl=en&view_op=list_hcore&venue=0032SoU2xY4J.2025&vq=en&cstart=220). Meanwhile, he has over 325 US and non-US patent applications (159 granted), which are transformed into 22 recorded Technical Transfer solutions [<font color="DodgerBlue">[Intel Labs Workstream PPTDoc 1, internal access only]</font>](https://ilworkstream.intel.com/Reviews/View/7523),[<font color="DodgerBlue">[2]</font>](https://ilworkstream.intel.com/Reviews/View/7522),[<font color="DodgerBlue">[3]</font>](https://ilworkstream.intel.com/Reviews/View/7356),[<font color="DodgerBlue">[4]</font>](https://ilworkstream.intel.com/Reviews/View/7209),[<font color="DodgerBlue">[5]</font>](https://ilworkstream.intel.com/Reviews/View/7200),[<font color="DodgerBlue">[6]</font>](https://ilworkstream.intel.com/Reviews/View/7184),[<font color="DodgerBlue">[7]</font>](https://ilworkstream.intel.com/Reviews/View/7165),[<font color="DodgerBlue">[8]</font>](https://ilworkstream.intel.com/Reviews/View/7024),[<font color="DodgerBlue">[9]</font>](https://ilworkstream.intel.com/Reviews/View/6875),[<font color="DodgerBlue">[10]</font>](https://ilworkstream.intel.com/Reviews/View/6851),[<font color="DodgerBlue">[11]</font>](https://ilworkstream.intel.com/Reviews/View/6781),[<font color="DodgerBlue">[12]</font>](https://ilworkstream.intel.com/Reviews/View/6679),[<font color="DodgerBlue">[13]</font>](https://ilworkstream.intel.com/Reviews/View/6555),[<font color="DodgerBlue">[14]</font>](https://ilworkstream.intel.com/Reviews/View/6342),[<font color="DodgerBlue">[15]</font>](https://ilworkstream.intel.com/Reviews/View/6343),[<font color="DodgerBlue">[16]</font>](https://ilworkstream.intel.com/Reviews/View/6258),[<font color="DodgerBlue">[17]</font>](https://ilworkstream.intel.com/Reviews/View/6257),[<font color="DodgerBlue">[18]</font>](https://ilworkstream.intel.com/Reviews/View/6213),[<font color="DodgerBlue">[19]</font>](https://ilworkstream.intel.com/Reviews/View/5011),[<font color="DodgerBlue">[20]</font>](https://ilworkstream.intel.com/Reviews/View/4362),[<font color="DodgerBlue">[21]</font>](https://ilworkstream.intel.com/Reviews/View/3323),[<font color="DodgerBlue">[22]</font>](https://ilworkstream.intel.com/Reviews/View/1160) to Intel Business Groups. They are broadly ***adopted in Intel AI stack of HW, SW and App***: [***HW-1***] low-bit inference IPs for low-power NPU integrated on Intel Core Ultra processor familes including Meteor/Lunar/Arrow Lake (and also for Intel Arria Series FPGAs); [***HW-2***] ultra-efficient head pose estimation IPs (our designed model is super low-power yet high accurate: 186 KB run-time memory cost, 2 MFLOPs computational cost and less than 3.85 degree error averaged on 1 million of commercial head pose data created by ourseleves, demoed on CES 2020 at Las Vegas) for Intel Visual Sensing Controller, namely low-power companion chip CVF/CVF+ (Clover Falls, or say, Project Athena) for the 11th/12th/13th Intel core processor Tiger/Alder/Raptor Lake; [***HW-3***] validating key usages (scale-up/down batch size with HyperNorm) on Xe-1 GPU architecture; [***SW-1***] advanced vision AI models in SW Development Kits, e.g., lightweight HBONet backbone model family (its model size is in the range of 0.2-3.6 millions of parameters and its computational cost is in the range of 14-305 MFLOPs) in Intel OpenVINO Toolkit and face analysis model family (including real-time facial landmark detection, tacking and facial expression recognition) in Intel RealSense SDK; [***SW-2***] User-friendly Model Booster (UMB) tool (including a series of knowledge distillation IPs for image classifcation, semantic segmentation, object detection and instance segmentation tasks) for Edge AI inference workloads and Input-size Swtichable Networks (INS-Nets, one parameter-shared model can switch over different image resolutions and shows better accuracy compared to separately trained models on each image resoltuion) for XeSeg tailored for live video human segmentation on Intel Xe-1/-2 GPU; [***App-1***] core technologies (AccTuning, SliderQuant and HieTR) to power [<font color="DodgerBlue">[Intel Smart PC Assistant]</font>](https://www.intel.cn/content/www/cn/zh/architecture-and-technology/core-ultra-ai-pc.html)(or say, [<font color="DodgerBlue">[Yingtao App]</font>](https://cherry.pcelves.com) released for China AIPC Market: PCs, Desktops, mini PCs and AI Boxes (from Mechrevo, GMK, Ningmei, MLOONG, etc) preloaded with Yingtao App and powered with ARL-H processors have been on sale since July 2025, with the shipments exceeding 100K units as of Apirl 2026. It smoothly runs on a local NPU/iGPU integrated into Core Ultra processor familes such as Arrow Lake, Lunar Lake and Panther Lake (the first core processor with Intel 18A process); [***App-2***], AI NAS agent, to name a few. He has been recognized with numerous Awards at Intel, such as Intel Innovator (the first and so far the only winner employee from China), Top-1 Inventor of Intel Labs (had 34 PCT/US patent applications approved in a single year, keeping the highest record so far), CTO recognition of exceptional contributions (low-bit AI inference IPs for NPU) to the Intel Core Ultra (code-named Meteor Lake) for laptops, 3 times of annual Intel Labs Gordy Awards (the highest annual research award named after Intel's co-founder Gordon Earle Moore), and 2 times of annual Intel China Awards. He also led the team and won the Winner of the prestigious [<font color="DodgerBlue">[EmotiW Challenge 2015]</font>](https://icmi.acm.org/2015/index.php?id=challenges#gc2),[<font color="DodgerBlue">[EmotiW Challenge 2017]</font>](https://icmi.acm.org/2017/index.php?id=challenges) held by ACM ICMI, beating out 74/100+ teams across the world. He served or is serving as a Senior Area Chair or an Area Chair or a Senior PC to NeurIPS, ICML and AAAI for multiple times<!-- [<font color="DodgerBlue">[NeurIPS 2024]</font>](https://neurips.cc/Conferences/2024/ProgramCommittee),[<font color="DodgerBlue">[NeurIPS 2025]</font>](https://neurips.cc/Conferences/2025/ProgramCommittee),[<font color="DodgerBlue">[NeurIPS 2026]</font>](https://neurips.cc/Conferences/2026/ProgramCommittee),[<font color="DodgerBlue">[ICML 2025]</font>](https://icml.cc/Conferences/2025/ProgramCommittee),[<font color="DodgerBlue">[ICML 2026]</font>](https://icml.cc/Conferences/2026/ProgramCommittee),[<font color="DodgerBlue">[AAAI 2022]</font>](https://aaai.org/conference/aaai/aaai-22/aaai-22-senior-program-committee/),[<font color="DodgerBlue">[AAAI 2026]</font>](https://aaai.org/conference/aaai/aaai-26/aaai-26-senior-program-committee/) -->, and was selected as a NeurIPS 2022 "Top Reviewer" and NeurIPS 2024 & 2025 "Area Chair" (awarded with a complimentary full registration to the conference). He demonstrated outstanding skills in mentoring interns/team members, and many of them have already grown into top young researchers in the field. He received his Ph.D. degree from Tsinghua University in January 2010 and his publications have over 10000 Google Scholar Citations.
...
+ June<!--24th-->, 2026. I will be serving as a Senior Program Committee member for AAAI 2027.
+ May<!--1st-->, 2026. Our paper CAT-Q, Cost-efficient and Accurate Ternary Quantization for 1.58-bit LLMs in the post-training regime, is accepted to ICML 2026 as an oral.
+ March<!--24th-->, 2026. I will be serving as a Senior Area Chair for NeurIPS 2026.
...
+ January<!--26th-->, 2026. Our paper SliderQuant, Sliding-layer Quantization for compressing and accelerating LLMs, is accepted to ICLR 2026. 
...
+ July<!--11th-->, 2025. I will be serving as a Senior Program Committee member for AAAI 2026.
...
+ December<!--12th-->, 2024. I have been selected as a NeurIPS 2024 "Area Chair" awarded with a complimentary full registration. 
...
+ October<!--13th-->, 2022. I have been selected as a NeurIPS 2022 "Top (a.k.a. Outstanding) Reviewer" awarded with a complimentary full registration. 
...
+ August<!--11th-->, 2021. I will be serving as a Senior Program Committee member for AAAI 2022.
...
+ July<!--5th-->, 2018. Our work SGC (Spatial Group Convolution) is accepted as an oral paper to ECCV 2018.
...
+ March<!--1st-->, 2016. Our work HyperNet is accepted as a spotlight paper to CVPR 2016.
...
+ CAT-Q: Cost-efficient and Accurate Ternary Quantization for LLMs.<br> Shigeng Wang\*\+, Chao Li\*\+, Yangyuxuan Kang\*, Jiawei Fan\* and Anbang Yao\#.<br><em>**International Conference on Machine Learning (ICML)**</em>, 2026 (<font color="Crimson">Oral</font>).<br> [<font color="DodgerBlue">[Paper will be coming soon]</font>](https://yaoanbang.github.io/).[<font color="DodgerBlue">[Code will be coming soon]</font>](https://yaoanbang.github.io/).<br>
...
+ [Shigeng Wang](https://genggng.github.io/) (Beijing University of Posts and Telecommunications)
...
+ CTO Recognition of exceptional contributions (low-bit AI inference IPs on NPU, INT8/INT4 [INT2 is also designed yet not enabled currently]) to the Intel Core Ultra (code-named Meteor Lake) for laptops, 2023.
+ NeurIPS 2022 "Top (a.k.a. Outstanding) Reviewer" awarded with a complimentary full registration 
+ Eureka Award 2022/2017, quarterly Innovator Winner of Intel Labs (had 10/25 US patent applications approved in a single quarter), 1 out of ~800/1000 Research Scientists of Intel Labs
+ 5 Intel China Quarterly Awards in 2018~2025, for great technical impacts to Intel China business
+ 1 Outstanding Invention Award in 2021, for strong merits to future Intel AI HW designs
...
+ Conference (Senior) Program Committee member/(Senior) Area Chair or Reviewer: CVPR, ICCV, ECCV, NeurIPS, ICML, ICLR, AAAI, BMVC, WACV, ACCV, ICMI, etc.
